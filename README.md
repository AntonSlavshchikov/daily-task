...
`php artisan schedule:test` - выполнить команду мгновенно, но сначала появится список с запланированными задачи
из которого нужно выбрать нужный, в данном случае под цифрой "0" так как задача всего одна.<br/>
